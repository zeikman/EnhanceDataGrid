<?php
  ...
  $js_source_path   = "$src_path/EnhanceDataGrid.js";
  $js_min_filename  = "EnhanceDataGrid.min.js";
  ...
  $css_source_path  = "$src_path/EnhanceDataGrid.css";
  $css_min_filename = "EnhanceDataGrid.min.css";
